...
export default function Home() {
    return (
        <div>
            ...
            <button className="text-6xl border-4 w-28 h-28 flex items-center justify-center rounded-full font-mono right-20 fixed bottom-20" onClick={ () => { console.log("🔥")} }>+</button>
